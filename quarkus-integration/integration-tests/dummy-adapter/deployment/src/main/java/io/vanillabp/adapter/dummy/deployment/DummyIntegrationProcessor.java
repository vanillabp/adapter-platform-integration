...
class DummyIntegrationProcessor {
  ...
  /**
   * Registers the producer of the dummy adapter's
   * {@link io.vanillabp.integration.adapter.spi.MigratableProcessService} bean picked up by
  ...
  AdditionalBeanBuildItem registerProcessServiceProducer() {
    ...
    return AdditionalBeanBuildItem
        .builder()
        .addBeanClass(DummyProcessServiceProducer.class)
        .setUnremovable()
        .build();
