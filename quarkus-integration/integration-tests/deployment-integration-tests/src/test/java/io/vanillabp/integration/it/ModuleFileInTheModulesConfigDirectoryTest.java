 ...
 * <i>test-module/config/test-module.yaml</i>. Spring Boot reads that place, Quarkus does not.
 */
@ExtendWith(SuppressOutputExtension.class)
public class ModuleFileInTheModulesConfigDirectoryTest {

  @RegisterExtension
  static final QuarkusExtensionTest extensionTest = new QuarkusExtensionTest()
      .withApplicationRoot(jar -> jar
          .addAsResource("config-directory/application.yaml", "application.yaml")
          .addAsResource("config-directory/test-module.yaml", "test-module/config/test-module.yaml")
      ...
      .assertLogRecords(records -> {
        ...
        Assertions.assertTrue(
            messages
                .stream()
                .anyMatch(message -> message.contains("test-module/config/test-module.yaml") && message
                    .contains("which belongs at 'test-module/test-module.yaml'")),
  ...
  @Test
  @DisplayName("None of the settings of a file in 'test-module/config/' are there")
