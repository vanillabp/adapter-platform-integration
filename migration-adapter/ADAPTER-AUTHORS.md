...
| `UNKNOWN_TO_BPMS` for a workflow, with a hint | the operation is planned and the caller returns | waits out your window, then repeats the entry | waits out your window, then a workflow-not-found error |
