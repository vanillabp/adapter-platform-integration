...
public class ExtensionSettingsPositionsTest {
  ...
  private static final String OTHER_ADAPTER = "the-other-bpms";

  private static final String EXTENSION = SampleNoteContract.EXTENSION_ID;
  ...
  public void theAdapterSectionWinsOverItsLevel() {
    ...
    assertEquals("application/the-bpms", resolved(null, null, null, ADAPTER));
    assertEquals("workflow-module/the-bpms", resolved(MODULE, null, null, ADAPTER));
    assertEquals("workflow/the-bpms", resolved(MODULE, PROCESS, null, ADAPTER));
    assertEquals("task/the-bpms", resolved(MODULE, PROCESS, TASK, ADAPTER));
  ...
  public void theSecondAdapterReadsItsOwnValues() {
    ...
    assertEquals("application/the-other-bpms", resolved(null, null, null, OTHER_ADAPTER));
    assertEquals("workflow-module/the-other-bpms", resolved(MODULE, null, null, OTHER_ADAPTER));
    assertEquals("workflow/the-other-bpms", resolved(MODULE, PROCESS, null, OTHER_ADAPTER));
    assertEquals("task/the-other-bpms", resolved(MODULE, PROCESS, TASK, OTHER_ADAPTER));
