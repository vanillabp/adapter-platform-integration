...
2. **[dummy-extension](./dummy-extension):**<br>
   ...
   [https://www.vanillabp.io](https://www.vanillabp.io).
3. **[main-integration-test](./main-integration-test):**<br>
   This module contains the main integration test.
4. **[test-applications](./test-applications):**<br>
   This module contains the test applications used by integration tests.
5. **[workflowmodule-integration-tests](./workflowmodule-integration-tests):**<br>
