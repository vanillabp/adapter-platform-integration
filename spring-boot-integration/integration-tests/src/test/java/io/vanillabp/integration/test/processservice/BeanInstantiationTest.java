...
@SpringBootTest(
    classes = {
        DummyAdapterConfiguration.class, SpringBootMigrationAdapterAutoConfiguration.class, SampleWorkflowService.class, io.vanillabp.integration.test.sample2.SampleWorkflowService.class
    }
)
