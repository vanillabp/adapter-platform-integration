...
public class WorkflowModulesTest {
  ...
  public void testMultipleGlobalWorkflowModuleDescriptorFilesFail() {
    ...
    final var workflowModules = List.of(
        WorkflowModule.builder().workflowModuleId("1").sourceUri(URI.create("file:///1")).build(),
        WorkflowModule.builder().workflowModuleId("2").sourceUri(URI.create("file:///2")).build());
